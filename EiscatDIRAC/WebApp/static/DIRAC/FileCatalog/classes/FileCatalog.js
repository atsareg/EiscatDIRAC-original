Ext.define('DIRAC.FileCatalog.classes.FileCatalog', {
      ...
      buildUI : function() {
        ...
        me.pagingToolbar.pageSizeCombo = new Ext.form.field.ComboBox({
              ...
              editable : false,
              maxLength : 4,
              maxLengthText : 'The maximum value for this field is 50000',
              minLength : 1,
        ...
        var pagingToolbarItems = [ me.pagingToolbar.btnSaveFiles, me.pagingToolbar.btnSelectedFiles2Launchpad, me.pagingToolbar.btnGrouping, me.pagingToolbar.btnShowQuery, '-', '-', '->', me.pagingToolbar.updateStamp, '-', 'Items per page: ', me.pagingToolbar.pageSizeCombo, '-'];
        ...
        */
        ...
        me.filesGrid = Ext.create('Ext.grid.Panel', {
              ...
              columns : [
                    //  do nothing by checkbox, go by checkboxmodel
                 //  {
      ...
      __getSelectedFiles : function() {
        ...
        var selection = Ext.getCmp('myFilesGrid').getSelectionModel().getSelection();
      ...
      __getSelectedFiles2Launchpad : function() {
        ...
        //location.href = GLOBAL.BASE_URL + 'JobLaunchpad/openLaunchpadWithLFNs?path=' + encodeURIComponent(oSendData.join(","));
